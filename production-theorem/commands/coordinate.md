...
Run the production-theorem:harness-coordinate skill against the user's message.
...
2. Invoke the `production-theorem:harness-coordinate` skill with the full argument string.
