...
3. Invoke the `production-theorem:harness_theorem` skill via the Skill tool, passing the full argument string. The skill body (`skills/harness_theorem/SKILL.md`) is the authoritative spec for planning, context compilation, coordination, delegation, action rail, validation, memory, and reporting.
