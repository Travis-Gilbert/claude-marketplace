...
Bounded pure Graph Lisp execution is source-present but has no current MCP, GraphQL, or dynamic projection.
...
|---|---|---|---|---|---|---|
| `rustyred_thg_graph_lisp::execute_capability` | rust | repository-only execution seam | source-only | unmounted | `rustyred-thg-graph-lisp` | — |
