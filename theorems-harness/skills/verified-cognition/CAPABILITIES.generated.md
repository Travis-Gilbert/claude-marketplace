...
# Verified cognition capability catalog
...
|---|---|---|---|---|---|---|
| `verified cognition composition` | behavior | compose solver, reconstruction, verification, and Plan evidence | composition only | no dedicated orchestrator | `references/VERIFIED_COGNITION_CAPABILITY.md` | — |

Behavioral contract: `references/VERIFIED_COGNITION_CAPABILITY.md` in the source plugin.
