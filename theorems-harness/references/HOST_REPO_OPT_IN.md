...
- prefer `/harness mode=plan` for planning
- prefer `/harness mode=plan handoff=spark` when the work can be split into
...
- use `/harness mode=plan` or equivalent planning flow for migrations,
