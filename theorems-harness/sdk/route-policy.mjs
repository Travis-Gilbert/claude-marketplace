...
const VERB_FAMILIES = Object.freeze({
  ...
  read_messages_for_room: "coordination",
  read_records_for_room: "coordination",
  coordinate: "coordination",
  mentions: "coordination",
  presence: "coordination",
  coordination_context: "coordination",
  stream_publish: "coordination",
  stream_read: "coordination",
  stream_ack: "coordination",
  stream_subscribe: "coordination",
  stream_unsubscribe: "coordination",
  job_submit: "coordination",
  job_list: "coordination",
  job_note: "coordination",
  job_archive: "coordination",
  spawn_session: "coordination",
