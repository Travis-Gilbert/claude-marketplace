...
reads it from this file), so this file is the source of truth, mirrored here for
Codex and for non-hook moments. Full protocol: `skills/harness-coordinate/SKILL.md`.
