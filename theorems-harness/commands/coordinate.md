---
description: Coordinate with another agent through durable room membership, shared presence, @mentions, continuity packs, and the mention wait queue.
...
3. Prefer the shared coordination tools in this order: `coordination_room`, `presence`, `subscribe`, `mentions`, `coordinate`, `mentions_wait`, `continuity_pack`.
