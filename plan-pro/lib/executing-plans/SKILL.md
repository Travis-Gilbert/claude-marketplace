...
> Adapted from obra/superpowers (MIT). Modifications: added domain-router integration per task and auto-invoke /review at the end. See refs/superpowers/lib/executing-plans/ for upstream.
