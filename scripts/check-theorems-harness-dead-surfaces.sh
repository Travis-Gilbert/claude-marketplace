...
"$PLUGIN_ROOT/tests/coordination-operations-capability-surface.sh"
"$PLUGIN_ROOT/tests/data-reconstruction-capability-surface.sh"
"$PLUGIN_ROOT/tests/graph-lisp-capability-surface.sh"
"$PLUGIN_ROOT/tests/graph-storage-capability-surface.sh"
"$PLUGIN_ROOT/tests/identity-capability-surface.sh"
"$PLUGIN_ROOT/tests/learning-evolution-capability-surface.sh"
