...
Every epistemic primitive in research_api carries a SHA-linked provenance trail. A provenance chain is the complete history of an object from capture to current state:
...
- The research_api `engine.py` Pass 7 for claim-level causal transfer
