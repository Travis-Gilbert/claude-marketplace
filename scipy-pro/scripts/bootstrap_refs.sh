...
Clones (shallow) the library source repos used by scipy-pro agents into a
local reference directory. Optionally symlinks a research_api checkout.
...
repos=(
  ...
  "firecrawl https://github.com/mendableai/firecrawl.git"
